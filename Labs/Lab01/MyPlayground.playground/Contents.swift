...
// Exercise 3
func VerifyName(list: [String], name: String) -> Bool
{
    for theName in list
    {
        if theName == name
...
VerifyName(list:listOfNames, name:"Charlie")
VerifyName(list:listOfNames, name:"Brody")
...
var famousActors: [String]? = ["Matt Damon", "Joaquim Phoenix", "Jim Carrey"]
print("\(famousActors!)\n")
